<?php /* Smarty version 2.6.25-dev, created on 2015-09-30 08:14:36
         compiled from lesson12.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_radios', 'lesson12.tpl', 26, false),array('function', 'html_options', 'lesson12.tpl', 59, false),array('modifier', 'default', 'lesson12.tpl', 26, false),)), $this); ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
...
" placeholder="Ваше имя">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="email" class="form-control" id="email" value="<?php echo ((is_array($_tmp=@$this->_tpl_vars['email'])) ? $this->_run_mod_handler('default', true, $_tmp, '') : smarty_modifier_default($_tmp, '')); ?>
...
" placeholder="Номер телефона">
            ...
            <div class="form-group">
                ...
                <div> <label for="region">Город</label> <?php echo smarty_function_html_options(array('name' => 'location_id','options' => $this->_tpl_vars['cities'],'selected' => $this->_tpl_vars['location_id']), $this);?>
 </div>
